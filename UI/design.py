...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fechaFButton.setGeometry(QtCore.QRect(40, 10, 61, 21))
        ...
        self.opFButton.setGeometry(QtCore.QRect(150, 10, 101, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "FSC Movimientos"))
        self.groupBox1.setTitle(_translate("MainWindow", "Filtros"))
        self.fechaFButton.setText(_translate("MainWindow", "Fecha"))
        self.opFButton.setText(_translate("MainWindow", "No. Orden(es)"))
        self.fileGroup.setTitle(_translate("MainWindow", "Ruta Archivo"))
